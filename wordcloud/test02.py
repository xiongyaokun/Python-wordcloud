...
————————————————————————
————————————————————————
Generating a word cloud that assigns colors to words based on a predefined mapping from
colors to words
"""
...
class SimpleGroupColorFunc(object):
    ...
    default_color : str
      ...
      of any value from color_to_word.
    """
...
class GroupedColorFunc(object):
    ...
    Parameters
    ——————————
    color_to_word : dict(str -> list(str))
      A dictionary that maps a color to the list of words.
...
text = """The Zen of Python, by Tim Peters Beautiful is better than ugly.
...
grouped_color_func = GroupedColorFunc(color_to_word, default_color)

# Apply our color function
# 如果你也可以将color_func的参数设置为图片，详细说明请看下一部分
